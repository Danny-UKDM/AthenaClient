...
namespace AthenaClient
{
    public class Method1
    {
        ...
        public Method1(AmazonAthenaClient amazonAthenaClient) =>
            _amazonAthenaClient = amazonAthenaClient;


        public async Task Execute()
        {
            var queryExecutionId = await SubmitAthenaQuery(_amazonAthenaClient);
            await WaitForQueryToComplete(_amazonAthenaClient, queryExecutionId);
            await ProcessResultRows(_amazonAthenaClient, queryExecutionId);
        }
        ...
        private static async Task ProcessResultRows(IAmazonAthena athenaClient, string queryExecutionId)
        {
